  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (passwordStrength < 50) {
        throw new Error("Gunakan password yang lebih kuat");
      }
    ...
    <>
      <div className="mb-8">
        <Link href="/" className="flex gap-2 items-center">
          <img src="/logo.png" alt="Citizen Connect Logo" className="h-10" />
          <h1 className="text-2xl font-bold">Citizen Connect</h1>
        </Link>
      </div>
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Bergabung dengan Citizen Connect untuk melaporkan masalah di
            komunitas Anda
          </p>
        </div>
            ...
            {formData.password && (
              <div className="space-y-1 mt-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Gunakan 8+ karakter dengan kombinasi huruf, angka & simbol
                </p>
              </div>
            )}
          </div>
