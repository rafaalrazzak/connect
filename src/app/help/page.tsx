...
export default function HelpPage() {
	...
	const faqs: FAQ[] = [
		...
		},
		{
			...
			answer:
				"Untuk menghapus akun, buka Profile, pilih 'Privasi & Keamanan', lalu scroll ke bagian bawah dan pilih 'Hapus Akun'. Proses ini akan menghapus semua data Anda secara permanen dan tidak dapat dikembalikan. Pastikan Anda benar-benar ingin menghapus akun sebelum melanjutkan.",
			category: "account",
		},
	];
				...
				<div className="lg:col-span-2 space-y-6">
					<Card>
						...
						<CardContent className="space-y-6">
							...
							{/* FAQ List */}							{filteredFAQs.length > 0 ? (
								<Accordion type="single" collapsible className="w-full">
									{filteredFAQs.map((faq, index) => (
										<AccordionItem key={`faq-${faq.category}-${index}`} value={`item-${faq.category}-${index}`}>
								...
								<div className="text-center py-12">
									...
									<h3 className="font-semibold mb-2">Tidak ada FAQ yang cocok</h3>
					...
					<Alert>
						...
						<AlertDescription>
							...
							Untuk masalah teknis, coba refresh halaman atau update aplikasi ke versi terbaru.
						</AlertDescription>
					</Alert>
				</div>
